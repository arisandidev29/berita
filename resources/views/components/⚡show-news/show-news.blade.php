  <div x-data="{ isEditable: false }" @enable-edit.window="isEditable = true" @disable-edit.window="isEditable = false" c">
      ...
      <div class="shadow-md shadow-main-primary my-4 rounded-lg p-4">
          ...
          <div class="mx-auto max-w-fit">
              ...
              <div x-show="isEditable" x-cloak x-data="{ value: @entangle('content') }"
                  @trix-change="
      ...
      <div wire:loading wire:target='saveNews'
